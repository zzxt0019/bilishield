...
export function AdvanceSettingView(props: AdvanceSettingViewProps) {
    const {expireTime: updateExpireTime} = props;
...
interface AdvanceSettingViewProps {
    expireTime: (expireTime: number | undefined) => void;
}