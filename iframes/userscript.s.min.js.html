...
<span class="hljs-comment">// @version         1.1.1675933833452</span>
...
<span class="hljs-comment">// @description     bilibili屏蔽 更新时间: 2023-02-09 17:10:33.452</span>
...
`</span>+<span class="hljs-title function_">le</span>(t,e):(n.<span class="hljs-title function_">endsWith</span>(<span class="hljs-string">&quot; &quot;</span>)?<span class="hljs-string">&quot;&quot;</span>:<span class="hljs-string">&quot; &quot;</span>)+t,os=<span class="hljs-string">&quot;flow&quot;</span>,<span class="hljs-title class_">St</span>=<span class="hljs-string">&quot;block&quot;</span>,<span class="hljs-title class_">Xe</span>=<span class="hljs-string">&quot;quoted&quot;</span>;<span class="hljs-keyword">function</span> <span class="hljs-title function_">Ze</span>(<span class="hljs-params">n,e,t=<span class="hljs-string">&quot;flow&quot;</span>,{indentAtStart:s,lineWidth:i=<span class="hljs-number">80</span>,minContentWidth:r=<span class="hljs-number">20</span>,onFold:l,onOverflow:a}={}</span>){<span class="hljs-keyword">if</span>(!i||i&lt;<span class="hljs-number">0</span>)<span class="hljs-keyword">return</span> n;<span class="hljs-keyword">const</span> o=<span class="hljs-title class_">Math</span>.<span class="hljs-title function_">max</span>(<span class="hljs-number">1</span>+r,<span class="hljs-number">1</span>+i-e.<span class="hljs-property">length</span>);<span class="hljs-keyword">if</span>(n.<span class="hljs-property">length</span>&lt;=o)<span class="hljs-keyword">return</span> n;<span class="hljs-keyword">const</span> c=[],u={};<span class="hljs-keyword">let</span> f=i-e.<span class="hljs-property">length</span>;<span class="hljs-keyword">typeof</span> s==<span class="hljs-string">&quot;number&quot;</span>&amp;&amp;(s&gt;i-<span class="hljs-title class_">Math</span>.<span class="hljs-title function_">max</span>(<span class="hljs-number">2</span>,r)?c.<span class="hljs-title function_">push</span>(<span class="hljs-number">0</span>):f=i-s);<span class="hljs-keyword">let</span> h,d,y=!<span class="hljs-number">1</span>,p=-<span class="hljs-number">1</span>,g=-<span class="hljs-number">1</span>,w=-<span class="hljs-number">1</span>;t===<span class="hljs-title class_">St</span>&amp;&amp;(p=<span class="hljs-title function_">cs</span>(n,p),p!==-<span class="hljs-number">1</span>&amp;&amp;(f=p+o));<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> S;S=n[p+=<span class="hljs-number">1</span>];){<span class="hljs-keyword">if</span>(t===<span class="hljs-title class_">Xe</span>&amp;&amp;S===<span class="hljs-string">&quot;\\&quot;</span>){<span class="hljs-keyword">switch</span>(g=p,n[p+<span class="hljs-number">1</span>]){<span class="hljs-keyword">case</span><span class="hljs-string">&quot;x&quot;</span>:p+=<span class="hljs-number">3</span>;<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;u&quot;</span>:p+=<span class="hljs-number">5</span>;<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;U&quot;</span>:p+=<span class="hljs-number">9</span>;<span class="hljs-keyword">break</span>;<span class="hljs-attr">default</span>:p+=<span class="hljs-number">1</span>}w=p}<span class="hljs-keyword">if</span>(S===<span class="hljs-string">`
`</span>)t===<span class="hljs-title class_">St</span>&amp;&amp;(p=<span class="hljs-title function_">cs</span>(n,p)),f=p+o,h=<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>;<span class="hljs-keyword">else</span>{<span class="hljs-keyword">if</span>(S===<span class="hljs-string">&quot; &quot;</span>&amp;&amp;d&amp;&amp;d!==<span class="hljs-string">&quot; &quot;</span>&amp;&amp;d!==<span class="hljs-string">`
`</span>&amp;&amp;d!==<span class="hljs-string">&quot;	&quot;</span>){<span class="hljs-keyword">const</span> O=n[p+<span class="hljs-number">1</span>];O&amp;&amp;O!==<span class="hljs-string">&quot; &quot;</span>&amp;&amp;O!==<span class="hljs-string">`
`</span>&amp;&amp;O!==<span class="hljs-string">&quot;	&quot;</span>&amp;&amp;(h=p)}<span class="hljs-keyword">if</span>(p&gt;=f)<span class="hljs-keyword">if</span>(h)c.<span class="hljs-title function_">push</span>(h),f=h+o,h=<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>;<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(t===<span class="hljs-title class_">Xe</span>){<span class="hljs-keyword">for</span>(;d===<span class="hljs-string">&quot; &quot;</span>||d===<span class="hljs-string">&quot;	&quot;</span>;)d=S,S=n[p+=<span class="hljs-number">1</span>],y=!<span class="hljs-number">0</span>;<span class="hljs-keyword">const</span> O=p&gt;w+<span class="hljs-number">1</span>?p-<span class="hljs-number">2</span>:g-<span class="hljs-number">1</span>;<span class="hljs-keyword">if</span>(u[O])<span class="hljs-keyword">return</span> n;c.<span class="hljs-title function_">push</span>(O),u[O]=!<span class="hljs-number">0</span>,f=O+o,h=<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>}<span class="hljs-keyword">else</span> y=!<span class="hljs-number">0</span>}d=S}<span class="hljs-keyword">if</span>(y&amp;&amp;a&amp;&amp;<span class="hljs-title function_">a</span>(),c.<span class="hljs-property">length</span>===<span class="hljs-number">0</span>)<span class="hljs-keyword">return</span> n;l&amp;&amp;<span class="hljs-title function_">l</span>();<span class="hljs-keyword">let</span> b=n.<span class="hljs-title function_">slice</span>(<span class="hljs-number">0</span>,c[<span class="hljs-number">0</span>]);<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> S=<span class="hljs-number">0</span>;S&lt;c.<span class="hljs-property">length</span>;++S){<span class="hljs-keyword">const</span> O=c[S],_=c[S+<span class="hljs-number">1</span>]||n.<span class="hljs-property">length</span>;O===<span class="hljs-number">0</span>?b=<span class="hljs-string">`
...
<span class="hljs-subst">${o}</span>`</span>);<span class="hljs-keyword">if</span>(l){<span class="hljs-keyword">const</span> <span class="hljs-title function_">h</span>=p=&gt;{<span class="hljs-keyword">var</span> g;<span class="hljs-keyword">return</span> p.<span class="hljs-property">default</span>&amp;&amp;p.<span class="hljs-property">tag</span>!==<span class="hljs-string">&quot;tag:yaml.org,2002:str&quot;</span>&amp;&amp;((g=p.<span class="hljs-property">test</span>)==<span class="hljs-literal">null</span>?<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>:g.<span class="hljs-title function_">test</span>(f))},{<span class="hljs-attr">compat</span>:d,<span class="hljs-attr">tags</span>:y}=e.<span class="hljs-property">doc</span>.<span class="hljs-property">schema</span>;<span class="hljs-keyword">if</span>(y.<span class="hljs-title function_">some</span>(h)||d!=<span class="hljs-literal">null</span>&amp;&amp;d.<span class="hljs-title function_">some</span>(h))<span class="hljs-keyword">return</span> <span class="hljs-title class_">Ne</span>(r,e)}<span class="hljs-keyword">return</span> a?<span class="hljs-attr">f</span>:<span class="hljs-title class_">Ze</span>(f,o,os,<span class="hljs-title function_">et</span>(e))}<span class="hljs-keyword">function</span> <span class="hljs-title function_">_t</span>(<span class="hljs-params">n,e,t,s</span>){<span class="hljs-keyword">const</span>{<span class="hljs-attr">implicitKey</span>:i,<span class="hljs-attr">inFlow</span>:r}=e,l=<span class="hljs-keyword">typeof</span> n.<span class="hljs-property">value</span>==<span class="hljs-string">&quot;string&quot;</span>?<span class="hljs-attr">n</span>:<span class="hljs-title class_">Object</span>.<span class="hljs-title function_">assign</span>({},n,{<span class="hljs-attr">value</span>:<span class="hljs-title class_">String</span>(n.<span class="hljs-property">value</span>)});<span class="hljs-keyword">let</span>{<span class="hljs-attr">type</span>:a}=n;a!==A.<span class="hljs-property">QUOTE_DOUBLE</span>&amp;&amp;<span class="hljs-regexp">/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u</span>.<span class="hljs-title function_">test</span>(l.<span class="hljs-property">value</span>)&amp;&amp;(a=A.<span class="hljs-property">QUOTE_DOUBLE</span>);<span class="hljs-keyword">const</span> <span class="hljs-title function_">o</span>=u=&gt;{<span class="hljs-keyword">switch</span>(u){<span class="hljs-keyword">case</span> A.<span class="hljs-property">BLOCK_FOLDED</span>:<span class="hljs-keyword">case</span> A.<span class="hljs-property">BLOCK_LITERAL</span>:<span class="hljs-keyword">return</span> i||r?<span class="hljs-title class_">Ne</span>(l.<span class="hljs-property">value</span>,e):<span class="hljs-title function_">st</span>(l,e,t,s);<span class="hljs-keyword">case</span> A.<span class="hljs-property">QUOTE_DOUBLE</span>:<span class="hljs-keyword">return</span> <span class="hljs-title class_">Ke</span>(l.<span class="hljs-property">value</span>,e);<span class="hljs-keyword">case</span> A.<span class="hljs-property">QUOTE_SINGLE</span>:<span class="hljs-keyword">return</span> <span class="hljs-title class_">Et</span>(l.<span class="hljs-property">value</span>,e);<span class="hljs-keyword">case</span> A.<span class="hljs-property">PLAIN</span>:<span class="hljs-keyword">return</span> <span class="hljs-title class_">On</span>(l,e,t,s);<span class="hljs-attr">default</span>:<span class="hljs-keyword">return</span> <span class="hljs-literal">null</span>}};<span class="hljs-keyword">let</span> c=<span class="hljs-title function_">o</span>(a);<span class="hljs-keyword">if</span>(c===<span class="hljs-literal">null</span>){<span class="hljs-keyword">const</span>{<span class="hljs-attr">defaultKeyType</span>:u,<span class="hljs-attr">defaultStringType</span>:f}=e.<span class="hljs-property">options</span>,h=i&amp;&amp;u||f;<span class="hljs-keyword">if</span>(c=<span class="hljs-title function_">o</span>(h),c===<span class="hljs-literal">null</span>)<span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-title class_">Error</span>(<span class="hljs-string">`Unsupported default string type <span class="hljs-subst">${h}</span>`</span>)}<span class="hljs-keyword">return</span> c}<span class="hljs-keyword">function</span> <span class="hljs-title function_">us</span>(<span class="hljs-params">n,e</span>){<span class="hljs-keyword">const</span> t=<span class="hljs-title class_">Object</span>.<span class="hljs-title function_">assign</span>({<span class="hljs-attr">blockQuote</span>:!<span class="hljs-number">0</span>,<span class="hljs-attr">commentString</span>:<span class="hljs-title class_">En</span>,<span class="hljs-attr">defaultKeyType</span>:<span class="hljs-literal">null</span>,<span class="hljs-attr">defaultStringType</span>:<span class="hljs-string">&quot;PLAIN&quot;</span>,<span class="hljs-attr">directives</span>:<span class="hljs-literal">null</span>,<span class="hljs-attr">doubleQuotedAsJSON</span>:!<span class="hljs-number">1</span>,<span class="hljs-attr">doubleQuotedMinMultiLineLength</span>:<span class="hljs-number">40</span>,<span class="hljs-attr">falseStr</span>:<span class="hljs-string">&quot;false&quot;</span>,<span class="hljs-attr">flowCollectionPadding</span>:!<span class="hljs-number">0</span>,<span class="hljs-attr">indentSeq</span>:!<span class="hljs-number">0</span>,<span class="hljs-attr">lineWidth</span>:<span class="hljs-number">80</span>,<span class="hljs-attr">minContentWidth</span>:<span class="hljs-number">20</span>,<span class="hljs-attr">nullStr</span>:<span class="hljs-string">&quot;null&quot;</span>,<span class="hljs-attr">simpleKeys</span>:!<span class="hljs-number">1</span>,<span class="hljs-attr">singleQuote</span>:<span class="hljs-literal">null</span>,<span class="hljs-attr">trueStr</span>:<span class="hljs-string">&quot;true&quot;</span>,<span class="hljs-attr">verifyAliasOrder</span>:!<span class="hljs-number">0</span>},n.<span class="hljs-property">schema</span>.<span class="hljs-property">toStringOptions</span>,e);<span class="hljs-keyword">let</span> s;<span class="hljs-keyword">switch</span>(t.<span class="hljs-property">collectionStyle</span>){<span class="hljs-keyword">case</span><span class="hljs-string">&quot;block&quot;</span>:s=!<span class="hljs-number">1</span>;<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;flow&quot;</span>:s=!<span class="hljs-number">0</span>;<span class="hljs-keyword">break</span>;<span class="hljs-attr">default</span>:s=<span class="hljs-literal">null</span>}<span class="hljs-keyword">return</span>{<span class="hljs-attr">anchors</span>:<span class="hljs-keyword">new</span> <span class="hljs-title class_">Set</span>,<span class="hljs-attr">doc</span>:n,<span class="hljs-attr">flowCollectionPadding</span>:t.<span class="hljs-property">flowCollectionPadding</span>?<span class="hljs-string">&quot; &quot;</span>:<span class="hljs-string">&quot;&quot;</span>,<span class="hljs-attr">indent</span>:<span class="hljs-string">&quot;&quot;</span>,<span class="hljs-attr">indentStep</span>:<span class="hljs-keyword">typeof</span> t.<span class="hljs-property">indent</span>==<span class="hljs-string">&quot;number&quot;</span>?<span class="hljs-string">&quot; &quot;</span>.<span class="hljs-title function_">repeat</span>(t.<span class="hljs-property">indent</span>):<span class="hljs-string">&quot;  &quot;</span>,<span class="hljs-attr">inFlow</span>:s,<span class="hljs-attr">options</span>:t}}<span class="hljs-keyword">function</span> <span class="hljs-title function_">An</span>(<span class="hljs-params">n,e</span>){<span class="hljs-keyword">var</span> i,r,l,a;<span class="hljs-keyword">if</span>(e.<span class="hljs-property">tag</span>){<span class="hljs-keyword">const</span> o=n.<span class="hljs-title function_">filter</span>(<span class="hljs-function"><span class="hljs-params">c</span>=&gt;</span>c.<span class="hljs-property">tag</span>===e.<span class="hljs-property">tag</span>);<span class="hljs-keyword">if</span>(o.<span class="hljs-property">length</span>&gt;<span class="hljs-number">0</span>)<span class="hljs-keyword">return</span>(i=o.<span class="hljs-title function_">find</span>(<span class="hljs-function"><span class="hljs-params">c</span>=&gt;</span>c.<span class="hljs-property">format</span>===e.<span class="hljs-property">format</span>))!=<span class="hljs-literal">null</span>?<span class="hljs-attr">i</span>:o[<span class="hljs-number">0</span>]}<span class="hljs-keyword">let</span> t,s;<span class="hljs-keyword">if</span>(<span class="hljs-title function_">L</span>(e)){s=e.<span class="hljs-property">value</span>;<span class="hljs-keyword">const</span> o=n.<span class="hljs-title function_">filter</span>(<span class="hljs-function"><span class="hljs-params">c</span>=&gt;</span>{<span class="hljs-keyword">var</span> u;<span class="hljs-keyword">return</span>(u=c.<span class="hljs-property">identify</span>)==<span class="hljs-literal">null</span>?<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>:u.<span class="hljs-title function_">call</span>(c,s)});t=(r=o.<span class="hljs-title function_">find</span>(<span class="hljs-function"><span class="hljs-params">c</span>=&gt;</span>c.<span class="hljs-property">format</span>===e.<span class="hljs-property">format</span>))!=<span class="hljs-literal">null</span>?<span class="hljs-attr">r</span>:o.<span class="hljs-title function_">find</span>(<span class="hljs-function"><span class="hljs-params">c</span>=&gt;</span>!c.<span class="hljs-property">format</span>)}<span class="hljs-keyword">else</span> s=e,t=n.<span class="hljs-title function_">find</span>(<span class="hljs-function"><span class="hljs-params">o</span>=&gt;</span>o.<span class="hljs-property">nodeClass</span>&amp;&amp;s <span class="hljs-keyword">instanceof</span> o.<span class="hljs-property">nodeClass</span>);<span class="hljs-keyword">if</span>(!t){<span class="hljs-keyword">const</span> o=(a=(l=s==<span class="hljs-literal">null</span>?<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>:s.<span class="hljs-property">constructor</span>)==<span class="hljs-literal">null</span>?<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>:l.<span class="hljs-property">name</span>)!=<span class="hljs-literal">null</span>?<span class="hljs-attr">a</span>:<span class="hljs-keyword">typeof</span> s;<span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-title class_">Error</span>(<span class="hljs-string">`Tag not resolved for <span class="hljs-subst">${o}</span> value`</span>)}<span class="hljs-keyword">return</span> t}<span class="hljs-keyword">function</span> <span class="hljs-title function_">Nn</span>(<span class="hljs-params">n,e,{anchors:t,doc:s}</span>){<span class="hljs-keyword">if</span>(!s.<span class="hljs-property">directives</span>)<span class="hljs-keyword">return</span><span class="hljs-string">&quot;&quot;</span>;<span class="hljs-keyword">const</span> i=[],r=(<span class="hljs-title function_">L</span>(n)||$(n))&amp;&amp;n.<span class="hljs-property">anchor</span>;r&amp;&amp;<span class="hljs-title function_">is</span>(r)&amp;&amp;(t.<span class="hljs-title function_">add</span>(r),i.<span class="hljs-title function_">push</span>(<span class="hljs-string">`&amp;<span class="hljs-subst">${r}</span>`</span>));<span class="hljs-keyword">const</span> l=n.<span class="hljs-property">tag</span>?n.<span class="hljs-property">tag</span>:e.<span class="hljs-property">default</span>?<span class="hljs-attr">null</span>:e.<span class="hljs-property">tag</span>;<span class="hljs-keyword">return</span> l&amp;&amp;i.<span class="hljs-title function_">push</span>(s.<span class="hljs-property">directives</span>.<span class="hljs-title function_">tagString</span>(l)),i.<span class="hljs-title function_">join</span>(<span class="hljs-string">&quot; &quot;</span>)}<span class="hljs-keyword">function</span> <span class="hljs-title function_">me</span>(<span class="hljs-params">n,e,t,s</span>){<span class="hljs-keyword">var</span> o,c;<span class="hljs-keyword">if</span>(<span class="hljs-title function_">D</span>(n))<span class="hljs-keyword">return</span> n.<span class="hljs-title function_">toString</span>(e,t,s);<span class="hljs-keyword">if</span>(<span class="hljs-title class_">Ee</span>(n)){<span class="hljs-keyword">if</span>(e.<span class="hljs-property">doc</span>.<span class="hljs-property">directives</span>)<span class="hljs-keyword">return</span> n.<span class="hljs-title function_">toString</span>(e);<span class="hljs-keyword">if</span>((o=e.<span class="hljs-property">resolvedAliases</span>)!=<span class="hljs-literal">null</span>&amp;&amp;o.<span class="hljs-title function_">has</span>(n))<span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-title class_">TypeError</span>(<span class="hljs-string">&quot;Cannot stringify circular structure without alias nodes&quot;</span>);e.<span class="hljs-property">resolvedAliases</span>?e.<span class="hljs-property">resolvedAliases</span>.<span class="hljs-title function_">add</span>(n):e.<span class="hljs-property">resolvedAliases</span>=<span class="hljs-keyword">new</span> <span class="hljs-title class_">Set</span>([n]),n=n.<span class="hljs-title function_">resolve</span>(e.<span class="hljs-property">doc</span>)}<span class="hljs-keyword">let</span> i;<span class="hljs-keyword">const</span> r=<span class="hljs-title function_">R</span>(n)?<span class="hljs-attr">n</span>:e.<span class="hljs-property">doc</span>.<span class="hljs-title function_">createNode</span>(n,{<span class="hljs-attr">onTagObj</span>:<span class="hljs-function"><span class="hljs-params">u</span>=&gt;</span>i=u});i||(i=<span class="hljs-title class_">An</span>(e.<span class="hljs-property">doc</span>.<span class="hljs-property">schema</span>.<span class="hljs-property">tags</span>,r));<span class="hljs-keyword">const</span> l=<span class="hljs-title class_">Nn</span>(r,i,e);l.<span class="hljs-property">length</span>&gt;<span class="hljs-number">0</span>&amp;&amp;(e.<span class="hljs-property">indentAtStart</span>=((c=e.<span class="hljs-property">indentAtStart</span>)!=<span class="hljs-literal">null</span>?<span class="hljs-attr">c</span>:<span class="hljs-number">0</span>)+l.<span class="hljs-property">length</span>+<span class="hljs-number">1</span>);<span class="hljs-keyword">const</span> a=<span class="hljs-keyword">typeof</span> i.<span class="hljs-property">stringify</span>==<span class="hljs-string">&quot;function&quot;</span>?i.<span class="hljs-title function_">stringify</span>(r,e,t,s):<span class="hljs-title function_">L</span>(r)?<span class="hljs-title function_">_t</span>(r,e,t,s):r.<span class="hljs-title function_">toString</span>(e,t,s);<span class="hljs-keyword">return</span> l?<span class="hljs-title function_">L</span>(r)||a[<span class="hljs-number">0</span>]===<span class="hljs-string">&quot;{&quot;</span>||a[<span class="hljs-number">0</span>]===<span class="hljs-string">&quot;[&quot;</span>?<span class="hljs-string">`<span class="hljs-subst">${l}</span> <span class="hljs-subst">${a}</span>`</span>:<span class="hljs-string">`<span class="hljs-subst">${l}</span>
<span class="hljs-subst">${e.indent}</span><span class="hljs-subst">${a}</span>`</span>:a}<span class="hljs-keyword">function</span> <span class="hljs-title function_">Tn</span>(<span class="hljs-params">{key:n,value:e},t,s,i</span>){<span class="hljs-keyword">var</span> C,K;<span class="hljs-keyword">const</span>{<span class="hljs-attr">allNullValues</span>:r,<span class="hljs-attr">doc</span>:l,<span class="hljs-attr">indent</span>:a,<span class="hljs-attr">indentStep</span>:o,<span class="hljs-attr">options</span>:{<span class="hljs-attr">commentString</span>:c,<span class="hljs-attr">indentSeq</span>:u,<span class="hljs-attr">simpleKeys</span>:f}}=t;<span class="hljs-keyword">let</span> h=<span class="hljs-title function_">R</span>(n)&amp;&amp;n.<span class="hljs-property">comment</span>||<span class="hljs-literal">null</span>;<span class="hljs-keyword">if</span>(f){<span class="hljs-keyword">if</span>(h)<span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-title class_">Error</span>(<span class="hljs-string">&quot;With simple keys, key nodes cannot have comments&quot;</span>);<span class="hljs-keyword">if</span>($(n)){<span class="hljs-keyword">const</span> G=<span class="hljs-string">&quot;With simple keys, collection cannot be used as a key value&quot;</span>;<span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-title class_">Error</span>(G)}}<span class="hljs-keyword">let</span> d=!f&amp;&amp;(!n||h&amp;&amp;e==<span class="hljs-literal">null</span>&amp;&amp;!t.<span class="hljs-property">inFlow</span>||$(n)||(<span class="hljs-title function_">L</span>(n)?n.<span class="hljs-property">type</span>===A.<span class="hljs-property">BLOCK_FOLDED</span>||n.<span class="hljs-property">type</span>===A.<span class="hljs-property">BLOCK_LITERAL</span>:<span class="hljs-keyword">typeof</span> n==<span class="hljs-string">&quot;object&quot;</span>));t=<span class="hljs-title class_">Object</span>.<span class="hljs-title function_">assign</span>({},t,{<span class="hljs-attr">allNullValues</span>:!<span class="hljs-number">1</span>,<span class="hljs-attr">implicitKey</span>:!d&amp;&amp;(f||!r),<span class="hljs-attr">indent</span>:a+o});<span class="hljs-keyword">let</span> y=!<span class="hljs-number">1</span>,p=!<span class="hljs-number">1</span>,g=<span class="hljs-title function_">me</span>(n,t,<span class="hljs-function">()=&gt;</span>y=!<span class="hljs-number">0</span>,<span class="hljs-function">()=&gt;</span>p=!<span class="hljs-number">0</span>);<span class="hljs-keyword">if</span>(!d&amp;&amp;!t.<span class="hljs-property">inFlow</span>&amp;&amp;g.<span class="hljs-property">length</span>&gt;<span class="hljs-number">1024</span>){<span class="hljs-keyword">if</span>(f)<span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-title class_">Error</span>(<span class="hljs-string">&quot;With simple keys, single line scalar must not span more than 1024 characters&quot;</span>);d=!<span class="hljs-number">0</span>}<span class="hljs-keyword">if</span>(t.<span class="hljs-property">inFlow</span>){<span class="hljs-keyword">if</span>(r||e==<span class="hljs-literal">null</span>)<span class="hljs-keyword">return</span> y&amp;&amp;s&amp;&amp;<span class="hljs-title function_">s</span>(),g===<span class="hljs-string">&quot;&quot;</span>?<span class="hljs-string">&quot;?&quot;</span>:d?<span class="hljs-string">`? <span class="hljs-subst">${g}</span>`</span>:g}<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(r&amp;&amp;!f||e==<span class="hljs-literal">null</span>&amp;&amp;d)<span class="hljs-keyword">return</span> g=<span class="hljs-string">`? <span class="hljs-subst">${g}</span>`</span>,h&amp;&amp;!y?g+=<span class="hljs-title function_">fe</span>(g,t.<span class="hljs-property">indent</span>,<span class="hljs-title function_">c</span>(h)):p&amp;&amp;i&amp;&amp;<span class="hljs-title function_">i</span>(),g;y&amp;&amp;(h=<span class="hljs-literal">null</span>),d?(h&amp;&amp;(g+=<span class="hljs-title function_">fe</span>(g,t.<span class="hljs-property">indent</span>,<span class="hljs-title function_">c</span>(h))),g=<span class="hljs-string">`? <span class="hljs-subst">${g}</span>
<span class="hljs-subst">${a}</span>:`</span>):(g=<span class="hljs-string">`<span class="hljs-subst">${g}</span>:`</span>,h&amp;&amp;(g+=<span class="hljs-title function_">fe</span>(g,t.<span class="hljs-property">indent</span>,<span class="hljs-title function_">c</span>(h))));<span class="hljs-keyword">let</span> w,b,S;<span class="hljs-title function_">R</span>(e)?(w=!!e.<span class="hljs-property">spaceBefore</span>,b=e.<span class="hljs-property">commentBefore</span>,S=e.<span class="hljs-property">comment</span>):(w=!<span class="hljs-number">1</span>,b=<span class="hljs-literal">null</span>,S=<span class="hljs-literal">null</span>,e&amp;&amp;<span class="hljs-keyword">typeof</span> e==<span class="hljs-string">&quot;object&quot;</span>&amp;&amp;(e=l.<span class="hljs-title function_">createNode</span>(e))),t.<span class="hljs-property">implicitKey</span>=!<span class="hljs-number">1</span>,!d&amp;&amp;!h&amp;&amp;<span class="hljs-title function_">L</span>(e)&amp;&amp;(t.<span class="hljs-property">indentAtStart</span>=g.<span class="hljs-property">length</span>+<span class="hljs-number">1</span>),p=!<span class="hljs-number">1</span>,!u&amp;&amp;o.<span class="hljs-property">length</span>&gt;=<span class="hljs-number">2</span>&amp;&amp;!t.<span class="hljs-property">inFlow</span>&amp;&amp;!d&amp;&amp;<span class="hljs-title class_">Re</span>(e)&amp;&amp;!e.<span class="hljs-property">flow</span>&amp;&amp;!e.<span class="hljs-property">tag</span>&amp;&amp;!e.<span class="hljs-property">anchor</span>&amp;&amp;(t.<span class="hljs-property">indent</span>=t.<span class="hljs-property">indent</span>.<span class="hljs-title function_">substring</span>(<span class="hljs-number">2</span>));<span class="hljs-keyword">let</span> O=!<span class="hljs-number">1</span>;<span class="hljs-keyword">const</span> _=<span class="hljs-title function_">me</span>(e,t,<span class="hljs-function">()=&gt;</span>O=!<span class="hljs-number">0</span>,<span class="hljs-function">()=&gt;</span>p=!<span class="hljs-number">0</span>);<span class="hljs-keyword">let</span> k=<span class="hljs-string">&quot; &quot;</span>;<span class="hljs-keyword">if</span>(h||w||b){<span class="hljs-keyword">if</span>(k=w?<span class="hljs-string">`
`</span>:<span class="hljs-string">&quot;&quot;</span>,b){<span class="hljs-keyword">const</span> G=<span class="hljs-title function_">c</span>(b);k+=<span class="hljs-string">`
<span class="hljs-subst">${le(G,t.indent)}</span>`</span>}_===<span class="hljs-string">&quot;&quot;</span>&amp;&amp;!t.<span class="hljs-property">inFlow</span>?k===<span class="hljs-string">`
`</span>&amp;&amp;(k=<span class="hljs-string">`

`</span>):k+=<span class="hljs-string">`
<span class="hljs-subst">${t.indent}</span>`</span>}<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(!d&amp;&amp;$(e)){<span class="hljs-keyword">const</span> G=_[<span class="hljs-number">0</span>],we=_.<span class="hljs-title function_">indexOf</span>(<span class="hljs-string">`
`</span>),J=we!==-<span class="hljs-number">1</span>,<span class="hljs-title class_">Fi</span>=(K=(C=t.<span class="hljs-property">inFlow</span>)!=<span class="hljs-literal">null</span>?<span class="hljs-attr">C</span>:e.<span class="hljs-property">flow</span>)!=<span class="hljs-literal">null</span>?<span class="hljs-attr">K</span>:e.<span class="hljs-property">items</span>.<span class="hljs-property">length</span>===<span class="hljs-number">0</span>;<span class="hljs-keyword">if</span>(J||!<span class="hljs-title class_">Fi</span>){<span class="hljs-keyword">let</span> tn=!<span class="hljs-number">1</span>;<span class="hljs-keyword">if</span>(J&amp;&amp;(G===<span class="hljs-string">&quot;&amp;&quot;</span>||G===<span class="hljs-string">&quot;!&quot;</span>)){<span class="hljs-keyword">let</span> ke=_.<span class="hljs-title function_">indexOf</span>(<span class="hljs-string">&quot; &quot;</span>);G===<span class="hljs-string">&quot;&amp;&quot;</span>&amp;&amp;ke!==-<span class="hljs-number">1</span>&amp;&amp;ke&lt;we&amp;&amp;_[ke+<span class="hljs-number">1</span>]===<span class="hljs-string">&quot;!&quot;</span>&amp;&amp;(ke=_.<span class="hljs-title function_">indexOf</span>(<span class="hljs-string">&quot; &quot;</span>,ke+<span class="hljs-number">1</span>)),(ke===-<span class="hljs-number">1</span>||we&lt;ke)&amp;&amp;(tn=!<span class="hljs-number">0</span>)}tn||(k=<span class="hljs-string">`
...
`</span>)&amp;&amp;(k=<span class="hljs-string">&quot;&quot;</span>);<span class="hljs-keyword">return</span> g+=k+_,t.<span class="hljs-property">inFlow</span>?O&amp;&amp;s&amp;&amp;<span class="hljs-title function_">s</span>():S&amp;&amp;!O?g+=<span class="hljs-title function_">fe</span>(g,t.<span class="hljs-property">indent</span>,<span class="hljs-title function_">c</span>(S)):p&amp;&amp;i&amp;&amp;<span class="hljs-title function_">i</span>(),g}<span class="hljs-keyword">function</span> <span class="hljs-title function_">Vi</span>(<span class="hljs-params">n,...e</span>){n===<span class="hljs-string">&quot;debug&quot;</span>&amp;&amp;<span class="hljs-variable language_">console</span>.<span class="hljs-title function_">log</span>(...e)}<span class="hljs-keyword">function</span> <span class="hljs-title function_">fs</span>(<span class="hljs-params">n,e</span>){(n===<span class="hljs-string">&quot;debug&quot;</span>||n===<span class="hljs-string">&quot;warn&quot;</span>)&amp;&amp;(<span class="hljs-keyword">typeof</span> process!=<span class="hljs-string">&quot;undefined&quot;</span>&amp;&amp;process.<span class="hljs-property">emitWarning</span>?process.<span class="hljs-title function_">emitWarning</span>(e):<span class="hljs-variable language_">console</span>.<span class="hljs-title function_">warn</span>(e))}<span class="hljs-keyword">const</span> hs=<span class="hljs-string">&quot;&lt;&lt;&quot;</span>;<span class="hljs-keyword">function</span> <span class="hljs-title function_">ds</span>(<span class="hljs-params">n,e,{key:t,value:s}</span>){<span class="hljs-keyword">if</span>(n!=<span class="hljs-literal">null</span>&amp;&amp;n.<span class="hljs-property">doc</span>.<span class="hljs-property">schema</span>.<span class="hljs-property">merge</span>&amp;&amp;<span class="hljs-title class_">Ln</span>(t))<span class="hljs-keyword">if</span>(s=<span class="hljs-title class_">Ee</span>(s)?s.<span class="hljs-title function_">resolve</span>(n.<span class="hljs-property">doc</span>):s,<span class="hljs-title class_">Re</span>(s))<span class="hljs-keyword">for</span>(<span class="hljs-keyword">const</span> i <span class="hljs-keyword">of</span> s.<span class="hljs-property">items</span>)<span class="hljs-title class_">Ot</span>(n,e,i);<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(<span class="hljs-title class_">Array</span>.<span class="hljs-title function_">isArray</span>(s))<span class="hljs-keyword">for</span>(<span class="hljs-keyword">const</span> i <span class="hljs-keyword">of</span> s)<span class="hljs-title class_">Ot</span>(n,e,i);<span class="hljs-keyword">else</span> <span class="hljs-title class_">Ot</span>(n,e,s);<span class="hljs-keyword">else</span>{<span class="hljs-keyword">const</span> i=<span class="hljs-title function_">ne</span>(t,<span class="hljs-string">&quot;&quot;</span>,n);<span class="hljs-keyword">if</span>(e <span class="hljs-keyword">instanceof</span> <span class="hljs-title class_">Map</span>)e.<span class="hljs-title function_">set</span>(i,<span class="hljs-title function_">ne</span>(s,i,n));<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(e <span class="hljs-keyword">instanceof</span> <span class="hljs-title class_">Set</span>)e.<span class="hljs-title function_">add</span>(i);<span class="hljs-keyword">else</span>{<span class="hljs-keyword">const</span> r=<span class="hljs-title class_">In</span>(t,i,n),l=<span class="hljs-title function_">ne</span>(s,r,n);r <span class="hljs-keyword">in</span> e?<span class="hljs-title class_">Object</span>.<span class="hljs-title function_">defineProperty</span>(e,r,{<span class="hljs-attr">value</span>:l,<span class="hljs-attr">writable</span>:!<span class="hljs-number">0</span>,<span class="hljs-attr">enumerable</span>:!<span class="hljs-number">0</span>,<span class="hljs-attr">configurable</span>:!<span class="hljs-number">0</span>}):e[r]=l}}<span class="hljs-keyword">return</span> e}<span class="hljs-keyword">const</span> <span class="hljs-title function_">Ln</span>=n=&gt;n===hs||<span class="hljs-title function_">L</span>(n)&amp;&amp;n.<span class="hljs-property">value</span>===hs&amp;&amp;(!n.<span class="hljs-property">type</span>||n.<span class="hljs-property">type</span>===A.<span class="hljs-property">PLAIN</span>);<span class="hljs-keyword">function</span> <span class="hljs-title function_">Ot</span>(<span class="hljs-params">n,e,t</span>){<span class="hljs-keyword">const</span> s=n&amp;&amp;<span class="hljs-title class_">Ee</span>(t)?t.<span class="hljs-title function_">resolve</span>(n.<span class="hljs-property">doc</span>):t;<span class="hljs-keyword">if</span>(!<span class="hljs-title function_">_e</span>(s))<span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-title class_">Error</span>(<span class="hljs-string">&quot;Merge sources must be maps or map aliases&quot;</span>);<span class="hljs-keyword">const</span> i=s.<span class="hljs-title function_">toJSON</span>(<span class="hljs-literal">null</span>,n,<span class="hljs-title class_">Map</span>);<span class="hljs-keyword">for</span>(<span class="hljs-keyword">const</span>[r,l]<span class="hljs-keyword">of</span> i)e <span class="hljs-keyword">instanceof</span> <span class="hljs-title class_">Map</span>?e.<span class="hljs-title function_">has</span>(r)||e.<span class="hljs-title function_">set</span>(r,l):e <span class="hljs-keyword">instanceof</span> <span class="hljs-title class_">Set</span>?e.<span class="hljs-title function_">add</span>(r):<span class="hljs-title class_">Object</span>.<span class="hljs-property"><span class="hljs-keyword">prototype</span></span>.<span class="hljs-property">hasOwnProperty</span>.<span class="hljs-title function_">call</span>(e,r)||<span class="hljs-title class_">Object</span>.<span class="hljs-title function_">defineProperty</span>(e,r,{<span class="hljs-attr">value</span>:l,<span class="hljs-attr">writable</span>:!<span class="hljs-number">0</span>,<span class="hljs-attr">enumerable</span>:!<span class="hljs-number">0</span>,<span class="hljs-attr">configurable</span>:!<span class="hljs-number">0</span>});<span class="hljs-keyword">return</span> e}<span class="hljs-keyword">function</span> <span class="hljs-title function_">In</span>(<span class="hljs-params">n,e,t</span>){<span class="hljs-keyword">if</span>(e===<span class="hljs-literal">null</span>)<span class="hljs-keyword">return</span><span class="hljs-string">&quot;&quot;</span>;<span class="hljs-keyword">if</span>(<span class="hljs-keyword">typeof</span> e!=<span class="hljs-string">&quot;object&quot;</span>)<span class="hljs-keyword">return</span> <span class="hljs-title class_">String</span>(e);<span class="hljs-keyword">if</span>(<span class="hljs-title function_">R</span>(n)&amp;&amp;t&amp;&amp;t.<span class="hljs-property">doc</span>){<span class="hljs-keyword">const</span> s=<span class="hljs-title function_">us</span>(t.<span class="hljs-property">doc</span>,{});s.<span class="hljs-property">anchors</span>=<span class="hljs-keyword">new</span> <span class="hljs-title class_">Set</span>;<span class="hljs-keyword">for</span>(<span class="hljs-keyword">const</span> r <span class="hljs-keyword">of</span> t.<span class="hljs-property">anchors</span>.<span class="hljs-title function_">keys</span>())s.<span class="hljs-property">anchors</span>.<span class="hljs-title function_">add</span>(r.<span class="hljs-property">anchor</span>);s.<span class="hljs-property">inFlow</span>=!<span class="hljs-number">0</span>,s.<span class="hljs-property">inStringifyKey</span>=!<span class="hljs-number">0</span>;<span class="hljs-keyword">const</span> i=n.<span class="hljs-title function_">toString</span>(s);<span class="hljs-keyword">if</span>(!t.<span class="hljs-property">mapKeyWarned</span>){<span class="hljs-keyword">let</span> r=<span class="hljs-title class_">JSON</span>.<span class="hljs-title function_">stringify</span>(i);r.<span class="hljs-property">length</span>&gt;<span class="hljs-number">40</span>&amp;&amp;(r=r.<span class="hljs-title function_">substring</span>(<span class="hljs-number">0</span>,<span class="hljs-number">36</span>)+<span class="hljs-string">&#x27;...&quot;&#x27;</span>),<span class="hljs-title function_">fs</span>(t.<span class="hljs-property">doc</span>.<span class="hljs-property">options</span>.<span class="hljs-property">logLevel</span>,<span class="hljs-string">`Keys with collection values will be stringified due to JS Object restrictions: <span class="hljs-subst">${r}</span>. Set mapAsMap: true to use object keys.`</span>),t.<span class="hljs-property">mapKeyWarned</span>=!<span class="hljs-number">0</span>}<span class="hljs-keyword">return</span> i}<span class="hljs-keyword">return</span> <span class="hljs-title class_">JSON</span>.<span class="hljs-title function_">stringify</span>(e)}<span class="hljs-keyword">function</span> <span class="hljs-title function_">At</span>(<span class="hljs-params">n,e,t</span>){<span class="hljs-keyword">const</span> s=<span class="hljs-title class_">Fe</span>(n,<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>,t),i=<span class="hljs-title class_">Fe</span>(e,<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>,t);<span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> <span class="hljs-title function_">V</span>(s,i)}<span class="hljs-keyword">class</span> <span class="hljs-title class_">V</span>{<span class="hljs-title function_">constructor</span>(<span class="hljs-params">e,t=<span class="hljs-literal">null</span></span>){<span class="hljs-title class_">Object</span>.<span class="hljs-title function_">defineProperty</span>(<span class="hljs-variable language_">this</span>,W,{<span class="hljs-attr">value</span>:<span class="hljs-title class_">Zt</span>}),<span class="hljs-variable language_">this</span>.<span class="hljs-property">key</span>=e,<span class="hljs-variable language_">this</span>.<span class="hljs-property">value</span>=t}<span class="hljs-title function_">clone</span>(<span class="hljs-params">e</span>){<span class="hljs-keyword">let</span>{<span class="hljs-attr">key</span>:t,<span class="hljs-attr">value</span>:s}=<span class="hljs-variable language_">this</span>;<span class="hljs-keyword">return</span> <span class="hljs-title function_">R</span>(t)&amp;&amp;(t=t.<span class="hljs-title function_">clone</span>(e)),<span class="hljs-title function_">R</span>(s)&amp;&amp;(s=s.<span class="hljs-title function_">clone</span>(e)),<span class="hljs-keyword">new</span> <span class="hljs-title function_">V</span>(t,s)}<span class="hljs-title function_">toJSON</span>(<span class="hljs-params">e,t</span>){<span class="hljs-keyword">const</span> s=t!=<span class="hljs-literal">null</span>&amp;&amp;t.<span class="hljs-property">mapAsMap</span>?<span class="hljs-keyword">new</span> <span class="hljs-title class_">Map</span>:{};<span class="hljs-keyword">return</span> <span class="hljs-title function_">ds</span>(t,s,<span class="hljs-variable language_">this</span>)}<span class="hljs-title function_">toString</span>(<span class="hljs-params">e,t,s</span>){<span class="hljs-keyword">return</span> e!=<span class="hljs-literal">null</span>&amp;&amp;e.<span class="hljs-property">doc</span>?<span class="hljs-title class_">Tn</span>(<span class="hljs-variable language_">this</span>,e,t,s):<span class="hljs-title class_">JSON</span>.<span class="hljs-title function_">stringify</span>(<span class="hljs-variable language_">this</span>)}}<span class="hljs-keyword">function</span> <span class="hljs-title function_">ps</span>(<span class="hljs-params">n,e,t</span>){<span class="hljs-keyword">var</span> r;<span class="hljs-keyword">return</span>(((r=e.<span class="hljs-property">inFlow</span>)!=<span class="hljs-literal">null</span>?<span class="hljs-attr">r</span>:n.<span class="hljs-property">flow</span>)?<span class="hljs-attr">vn</span>:<span class="hljs-title class_">Mn</span>)(n,e,t)}<span class="hljs-keyword">function</span> <span class="hljs-title function_">Mn</span>(<span class="hljs-params">{comment:n,items:e},t,{blockItemPrefix:s,flowChars:i,itemIndent:r,onChompKeep:l,onComment:a}</span>){<span class="hljs-keyword">const</span>{<span class="hljs-attr">indent</span>:o,<span class="hljs-attr">options</span>:{<span class="hljs-attr">commentString</span>:c}}=t,u=<span class="hljs-title class_">Object</span>.<span class="hljs-title function_">assign</span>({},t,{<span class="hljs-attr">indent</span>:r,<span class="hljs-attr">type</span>:<span class="hljs-literal">null</span>});<span class="hljs-keyword">let</span> f=!<span class="hljs-number">1</span>;<span class="hljs-keyword">const</span> h=[];<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> y=<span class="hljs-number">0</span>;y&lt;e.<span class="hljs-property">length</span>;++y){<span class="hljs-keyword">const</span> p=e[y];<span class="hljs-keyword">let</span> g=<span class="hljs-literal">null</span>;<span class="hljs-keyword">if</span>(<span class="hljs-title function_">R</span>(p))!f&amp;&amp;p.<span class="hljs-property">spaceBefore</span>&amp;&amp;h.<span class="hljs-title function_">push</span>(<span class="hljs-string">&quot;&quot;</span>),<span class="hljs-title function_">nt</span>(t,h,p.<span class="hljs-property">commentBefore</span>,f),p.<span class="hljs-property">comment</span>&amp;&amp;(g=p.<span class="hljs-property">comment</span>);<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(<span class="hljs-title function_">D</span>(p)){<span class="hljs-keyword">const</span> b=<span class="hljs-title function_">R</span>(p.<span class="hljs-property">key</span>)?p.<span class="hljs-property">key</span>:<span class="hljs-literal">null</span>;b&amp;&amp;(!f&amp;&amp;b.<span class="hljs-property">spaceBefore</span>&amp;&amp;h.<span class="hljs-title function_">push</span>(<span class="hljs-string">&quot;&quot;</span>),<span class="hljs-title function_">nt</span>(t,h,b.<span class="hljs-property">commentBefore</span>,f))}f=!<span class="hljs-number">1</span>;<span class="hljs-keyword">let</span> w=<span class="hljs-title function_">me</span>(p,u,<span class="hljs-function">()=&gt;</span>g=<span class="hljs-literal">null</span>,<span class="hljs-function">()=&gt;</span>f=!<span class="hljs-number">0</span>);g&amp;&amp;(w+=<span class="hljs-title function_">fe</span>(w,r,<span class="hljs-title function_">c</span>(g))),f&amp;&amp;g&amp;&amp;(f=!<span class="hljs-number">1</span>),h.<span class="hljs-title function_">push</span>(s+w)}<span class="hljs-keyword">let</span> d;<span class="hljs-keyword">if</span>(h.<span class="hljs-property">length</span>===<span class="hljs-number">0</span>)d=i.<span class="hljs-property">start</span>+i.<span class="hljs-property">end</span>;<span class="hljs-keyword">else</span>{d=h[<span class="hljs-number">0</span>];<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> y=<span class="hljs-number">1</span>;y&lt;h.<span class="hljs-property">length</span>;++y){<span class="hljs-keyword">const</span> p=h[y];d+=p?<span class="hljs-string">`
<span class="hljs-subst">${o}</span><span class="hljs-subst">${p}</span>`</span>:<span class="hljs-string">`
`</span>}}<span class="hljs-keyword">return</span> n?(d+=<span class="hljs-string">`
`</span>+<span class="hljs-title function_">le</span>(<span class="hljs-title function_">c</span>(n),o),a&amp;&amp;<span class="hljs-title function_">a</span>()):f&amp;&amp;l&amp;&amp;<span class="hljs-title function_">l</span>(),d}<span class="hljs-keyword">function</span> <span class="hljs-title function_">vn</span>(<span class="hljs-params">{comment:n,items:e},t,{flowChars:s,itemIndent:i,onComment:r}</span>){<span class="hljs-keyword">const</span>{<span class="hljs-attr">indent</span>:l,<span class="hljs-attr">indentStep</span>:a,<span class="hljs-attr">flowCollectionPadding</span>:o,<span class="hljs-attr">options</span>:{<span class="hljs-attr">commentString</span>:c}}=t;i+=a;<span class="hljs-keyword">const</span> u=<span class="hljs-title class_">Object</span>.<span class="hljs-title function_">assign</span>({},t,{<span class="hljs-attr">indent</span>:i,<span class="hljs-attr">inFlow</span>:!<span class="hljs-number">0</span>,<span class="hljs-attr">type</span>:<span class="hljs-literal">null</span>});<span class="hljs-keyword">let</span> f=!<span class="hljs-number">1</span>,h=<span class="hljs-number">0</span>;<span class="hljs-keyword">const</span> d=[];<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> w=<span class="hljs-number">0</span>;w&lt;e.<span class="hljs-property">length</span>;++w){<span class="hljs-keyword">const</span> b=e[w];<span class="hljs-keyword">let</span> S=<span class="hljs-literal">null</span>;<span class="hljs-keyword">if</span>(<span class="hljs-title function_">R</span>(b))b.<span class="hljs-property">spaceBefore</span>&amp;&amp;d.<span class="hljs-title function_">push</span>(<span class="hljs-string">&quot;&quot;</span>),<span class="hljs-title function_">nt</span>(t,d,b.<span class="hljs-property">commentBefore</span>,!<span class="hljs-number">1</span>),b.<span class="hljs-property">comment</span>&amp;&amp;(S=b.<span class="hljs-property">comment</span>);<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(<span class="hljs-title function_">D</span>(b)){<span class="hljs-keyword">const</span> _=<span class="hljs-title function_">R</span>(b.<span class="hljs-property">key</span>)?b.<span class="hljs-property">key</span>:<span class="hljs-literal">null</span>;_&amp;&amp;(_.<span class="hljs-property">spaceBefore</span>&amp;&amp;d.<span class="hljs-title function_">push</span>(<span class="hljs-string">&quot;&quot;</span>),<span class="hljs-title function_">nt</span>(t,d,_.<span class="hljs-property">commentBefore</span>,!<span class="hljs-number">1</span>),_.<span class="hljs-property">comment</span>&amp;&amp;(f=!<span class="hljs-number">0</span>));<span class="hljs-keyword">const</span> k=<span class="hljs-title function_">R</span>(b.<span class="hljs-property">value</span>)?b.<span class="hljs-property">value</span>:<span class="hljs-literal">null</span>;k?(k.<span class="hljs-property">comment</span>&amp;&amp;(S=k.<span class="hljs-property">comment</span>),k.<span class="hljs-property">commentBefore</span>&amp;&amp;(f=!<span class="hljs-number">0</span>)):b.<span class="hljs-property">value</span>==<span class="hljs-literal">null</span>&amp;&amp;_&amp;&amp;_.<span class="hljs-property">comment</span>&amp;&amp;(S=_.<span class="hljs-property">comment</span>)}S&amp;&amp;(f=!<span class="hljs-number">0</span>);<span class="hljs-keyword">let</span> O=<span class="hljs-title function_">me</span>(b,u,<span class="hljs-function">()=&gt;</span>S=<span class="hljs-literal">null</span>);w&lt;e.<span class="hljs-property">length</span>-<span class="hljs-number">1</span>&amp;&amp;(O+=<span class="hljs-string">&quot;,&quot;</span>),S&amp;&amp;(O+=<span class="hljs-title function_">fe</span>(O,i,<span class="hljs-title function_">c</span>(S))),!f&amp;&amp;(d.<span class="hljs-property">length</span>&gt;h||O.<span class="hljs-title function_">includes</span>(<span class="hljs-string">`
`</span>))&amp;&amp;(f=!<span class="hljs-number">0</span>),d.<span class="hljs-title function_">push</span>(O),h=d.<span class="hljs-property">length</span>}<span class="hljs-keyword">let</span> y;<span class="hljs-keyword">const</span>{<span class="hljs-attr">start</span>:p,<span class="hljs-attr">end</span>:g}=s;<span class="hljs-keyword">if</span>(d.<span class="hljs-property">length</span>===<span class="hljs-number">0</span>)y=p+g;<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(f||(f=d.<span class="hljs-title function_">reduce</span>(<span class="hljs-function">(<span class="hljs-params">b,S</span>)=&gt;</span>b+S.<span class="hljs-property">length</span>+<span class="hljs-number">2</span>,<span class="hljs-number">2</span>)&gt;ze.<span class="hljs-property">maxFlowStringSingleLineLength</span>),f){y=p;<span class="hljs-keyword">for</span>(<span class="hljs-keyword">const</span> w <span class="hljs-keyword">of</span> d)y+=w?<span class="hljs-string">`
...
`</span>:!d&amp;&amp;h===<span class="hljs-string">`
`</span>&amp;&amp;(h=<span class="hljs-string">`

`</span>),f+=h+g.<span class="hljs-title function_">slice</span>(o)+w,h=<span class="hljs-string">`
`</span>,d=!<span class="hljs-number">0</span>):w===<span class="hljs-string">&quot;&quot;</span>?h===<span class="hljs-string">`
`</span>?f+=<span class="hljs-string">`
`</span>:h=<span class="hljs-string">`
`</span>:(f+=h+w,h=<span class="hljs-string">&quot; &quot;</span>,d=!<span class="hljs-number">1</span>)}<span class="hljs-keyword">switch</span>(i.<span class="hljs-property">chomp</span>){<span class="hljs-keyword">case</span><span class="hljs-string">&quot;-&quot;</span>:<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;+&quot;</span>:<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> p=a;p&lt;l.<span class="hljs-property">length</span>;++p)f+=<span class="hljs-string">`
`</span>+l[p][<span class="hljs-number">0</span>].<span class="hljs-title function_">slice</span>(o);f[f.<span class="hljs-property">length</span>-<span class="hljs-number">1</span>]!==<span class="hljs-string">`
`</span>&amp;&amp;(f+=<span class="hljs-string">`
`</span>);<span class="hljs-keyword">break</span>;<span class="hljs-attr">default</span>:f+=<span class="hljs-string">`
`</span>}<span class="hljs-keyword">const</span> y=s+i.<span class="hljs-property">length</span>+n.<span class="hljs-property">source</span>.<span class="hljs-property">length</span>;<span class="hljs-keyword">return</span>{<span class="hljs-attr">value</span>:f,<span class="hljs-attr">type</span>:r,<span class="hljs-attr">comment</span>:i.<span class="hljs-property">comment</span>,<span class="hljs-attr">range</span>:[s,y,y]}}<span class="hljs-keyword">function</span> <span class="hljs-title function_">ei</span>(<span class="hljs-params">{offset:n,props:e},t,s</span>){<span class="hljs-keyword">if</span>(e[<span class="hljs-number">0</span>].<span class="hljs-property">type</span>!==<span class="hljs-string">&quot;block-scalar-header&quot;</span>)<span class="hljs-keyword">return</span> <span class="hljs-title function_">s</span>(e[<span class="hljs-number">0</span>],<span class="hljs-string">&quot;IMPOSSIBLE&quot;</span>,<span class="hljs-string">&quot;Block scalar header not found&quot;</span>),<span class="hljs-literal">null</span>;<span class="hljs-keyword">const</span>{<span class="hljs-attr">source</span>:i}=e[<span class="hljs-number">0</span>],r=i[<span class="hljs-number">0</span>];<span class="hljs-keyword">let</span> l=<span class="hljs-number">0</span>,a=<span class="hljs-string">&quot;&quot;</span>,o=-<span class="hljs-number">1</span>;<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> h=<span class="hljs-number">1</span>;h&lt;i.<span class="hljs-property">length</span>;++h){<span class="hljs-keyword">const</span> d=i[h];<span class="hljs-keyword">if</span>(!a&amp;&amp;(d===<span class="hljs-string">&quot;-&quot;</span>||d===<span class="hljs-string">&quot;+&quot;</span>))a=d;<span class="hljs-keyword">else</span>{<span class="hljs-keyword">const</span> y=<span class="hljs-title class_">Number</span>(d);!l&amp;&amp;y?l=<span class="hljs-attr">y</span>:o===-<span class="hljs-number">1</span>&amp;&amp;(o=n+h)}}o!==-<span class="hljs-number">1</span>&amp;&amp;<span class="hljs-title function_">s</span>(o,<span class="hljs-string">&quot;UNEXPECTED_TOKEN&quot;</span>,<span class="hljs-string">`Block scalar header includes extra characters: <span class="hljs-subst">${i}</span>`</span>);<span class="hljs-keyword">let</span> c=!<span class="hljs-number">1</span>,u=<span class="hljs-string">&quot;&quot;</span>,f=i.<span class="hljs-property">length</span>;<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> h=<span class="hljs-number">1</span>;h&lt;e.<span class="hljs-property">length</span>;++h){<span class="hljs-keyword">const</span> d=e[h];<span class="hljs-keyword">switch</span>(d.<span class="hljs-property">type</span>){<span class="hljs-keyword">case</span><span class="hljs-string">&quot;space&quot;</span>:c=!<span class="hljs-number">0</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;newline&quot;</span>:f+=d.<span class="hljs-property">source</span>.<span class="hljs-property">length</span>;<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;comment&quot;</span>:t&amp;&amp;!c&amp;&amp;<span class="hljs-title function_">s</span>(d,<span class="hljs-string">&quot;MISSING_CHAR&quot;</span>,<span class="hljs-string">&quot;Comments must be separated from other tokens by white space characters&quot;</span>),f+=d.<span class="hljs-property">source</span>.<span class="hljs-property">length</span>,u=d.<span class="hljs-property">source</span>.<span class="hljs-title function_">substring</span>(<span class="hljs-number">1</span>);<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;error&quot;</span>:<span class="hljs-title function_">s</span>(d,<span class="hljs-string">&quot;UNEXPECTED_TOKEN&quot;</span>,d.<span class="hljs-property">message</span>),f+=d.<span class="hljs-property">source</span>.<span class="hljs-property">length</span>;<span class="hljs-keyword">break</span>;<span class="hljs-attr">default</span>:{<span class="hljs-keyword">const</span> y=<span class="hljs-string">`Unexpected token in block scalar header: <span class="hljs-subst">${d.type}</span>`</span>;<span class="hljs-title function_">s</span>(d,<span class="hljs-string">&quot;UNEXPECTED_TOKEN&quot;</span>,y);<span class="hljs-keyword">const</span> p=d.<span class="hljs-property">source</span>;p&amp;&amp;<span class="hljs-keyword">typeof</span> p==<span class="hljs-string">&quot;string&quot;</span>&amp;&amp;(f+=p.<span class="hljs-property">length</span>)}}}<span class="hljs-keyword">return</span>{<span class="hljs-attr">mode</span>:r,<span class="hljs-attr">indent</span>:l,<span class="hljs-attr">chomp</span>:a,<span class="hljs-attr">comment</span>:u,<span class="hljs-attr">length</span>:f}}<span class="hljs-keyword">function</span> <span class="hljs-title function_">ti</span>(<span class="hljs-params">n</span>){<span class="hljs-keyword">const</span> e=n.<span class="hljs-title function_">split</span>(<span class="hljs-regexp">/\n( *)/</span>),t=e[<span class="hljs-number">0</span>],s=t.<span class="hljs-title function_">match</span>(<span class="hljs-regexp">/^( *)/</span>),r=[s!=<span class="hljs-literal">null</span>&amp;&amp;s[<span class="hljs-number">1</span>]?[s[<span class="hljs-number">1</span>],t.<span class="hljs-title function_">slice</span>(s[<span class="hljs-number">1</span>].<span class="hljs-property">length</span>)]:[<span class="hljs-string">&quot;&quot;</span>,t]];<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> l=<span class="hljs-number">1</span>;l&lt;e.<span class="hljs-property">length</span>;l+=<span class="hljs-number">2</span>)r.<span class="hljs-title function_">push</span>([e[l],e[l+<span class="hljs-number">1</span>]]);<span class="hljs-keyword">return</span> r}<span class="hljs-keyword">function</span> <span class="hljs-title function_">si</span>(<span class="hljs-params">n,e,t</span>){<span class="hljs-keyword">const</span>{<span class="hljs-attr">offset</span>:s,<span class="hljs-attr">type</span>:i,<span class="hljs-attr">source</span>:r,<span class="hljs-attr">end</span>:l}=n;<span class="hljs-keyword">let</span> a,o;<span class="hljs-keyword">const</span> <span class="hljs-title function_">c</span>=(<span class="hljs-params">h,d,y</span>)=&gt;<span class="hljs-title function_">t</span>(s+h,d,y);<span class="hljs-keyword">switch</span>(i){<span class="hljs-keyword">case</span><span class="hljs-string">&quot;scalar&quot;</span>:a=A.<span class="hljs-property">PLAIN</span>,o=<span class="hljs-title function_">ni</span>(r,c);<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;single-quoted-scalar&quot;</span>:a=A.<span class="hljs-property">QUOTE_SINGLE</span>,o=<span class="hljs-title function_">ii</span>(r,c);<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;double-quoted-scalar&quot;</span>:a=A.<span class="hljs-property">QUOTE_DOUBLE</span>,o=<span class="hljs-title function_">ri</span>(r,c);<span class="hljs-keyword">break</span>;<span class="hljs-attr">default</span>:<span class="hljs-keyword">return</span> <span class="hljs-title function_">t</span>(n,<span class="hljs-string">&quot;UNEXPECTED_TOKEN&quot;</span>,<span class="hljs-string">`Expected a flow scalar value, but found: <span class="hljs-subst">${i}</span>`</span>),{<span class="hljs-attr">value</span>:<span class="hljs-string">&quot;&quot;</span>,<span class="hljs-attr">type</span>:<span class="hljs-literal">null</span>,<span class="hljs-attr">comment</span>:<span class="hljs-string">&quot;&quot;</span>,<span class="hljs-attr">range</span>:[s,s+r.<span class="hljs-property">length</span>,s+r.<span class="hljs-property">length</span>]}}<span class="hljs-keyword">const</span> u=s+r.<span class="hljs-property">length</span>,f=<span class="hljs-title class_">He</span>(l,u,e,t);<span class="hljs-keyword">return</span>{<span class="hljs-attr">value</span>:o,<span class="hljs-attr">type</span>:a,<span class="hljs-attr">comment</span>:f.<span class="hljs-property">comment</span>,<span class="hljs-attr">range</span>:[s,u,f.<span class="hljs-property">offset</span>]}}<span class="hljs-keyword">function</span> <span class="hljs-title function_">ni</span>(<span class="hljs-params">n,e</span>){<span class="hljs-keyword">let</span> t=<span class="hljs-string">&quot;&quot;</span>;<span class="hljs-keyword">switch</span>(n[<span class="hljs-number">0</span>]){<span class="hljs-keyword">case</span><span class="hljs-string">&quot;	&quot;</span>:t=<span class="hljs-string">&quot;a tab character&quot;</span>;<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;,&quot;</span>:t=<span class="hljs-string">&quot;flow indicator character ,&quot;</span>;<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;%&quot;</span>:t=<span class="hljs-string">&quot;directive indicator character %&quot;</span>;<span class="hljs-keyword">break</span>;<span class="hljs-keyword">case</span><span class="hljs-string">&quot;|&quot;</span>:<span class="hljs-keyword">case</span><span class="hljs-string">&quot;&gt;&quot;</span>:{t=<span class="hljs-string">`block scalar indicator <span class="hljs-subst">${n[<span class="hljs-number">0</span>]}</span>`</span>;<span class="hljs-keyword">break</span>}<span class="hljs-keyword">case</span><span class="hljs-string">&quot;@&quot;</span>:<span class="hljs-keyword">case</span><span class="hljs-string">&quot;`&quot;</span>:{t=<span class="hljs-string">`reserved character <span class="hljs-subst">${n[<span class="hljs-number">0</span>]}</span>`</span>;<span class="hljs-keyword">break</span>}}<span class="hljs-keyword">return</span> t&amp;&amp;<span class="hljs-title function_">e</span>(<span class="hljs-number">0</span>,<span class="hljs-string">&quot;BAD_SCALAR_START&quot;</span>,<span class="hljs-string">`Plain value cannot start with <span class="hljs-subst">${t}</span>`</span>),<span class="hljs-title class_">Rs</span>(n)}<span class="hljs-keyword">function</span> <span class="hljs-title function_">ii</span>(<span class="hljs-params">n,e</span>){<span class="hljs-keyword">return</span>(n[n.<span class="hljs-property">length</span>-<span class="hljs-number">1</span>]!==<span class="hljs-string">&quot;&#x27;&quot;</span>||n.<span class="hljs-property">length</span>===<span class="hljs-number">1</span>)&amp;&amp;<span class="hljs-title function_">e</span>(n.<span class="hljs-property">length</span>,<span class="hljs-string">&quot;MISSING_CHAR&quot;</span>,<span class="hljs-string">&quot;Missing closing &#x27;quote&quot;</span>),<span class="hljs-title class_">Rs</span>(n.<span class="hljs-title function_">slice</span>(<span class="hljs-number">1</span>,-<span class="hljs-number">1</span>)).<span class="hljs-title function_">replace</span>(<span class="hljs-regexp">/&#x27;&#x27;/g</span>,<span class="hljs-string">&quot;&#x27;&quot;</span>)}<span class="hljs-keyword">function</span> <span class="hljs-title function_">Rs</span>(<span class="hljs-params">n</span>){<span class="hljs-keyword">var</span> o;<span class="hljs-keyword">let</span> e,t;<span class="hljs-keyword">try</span>{e=<span class="hljs-keyword">new</span> <span class="hljs-title class_">RegExp</span>(<span class="hljs-string">`(.*?)(?&lt;![ 	])[ 	]*\r?
...
`</span>:(i+=r+s[<span class="hljs-number">1</span>],r=<span class="hljs-string">&quot; &quot;</span>),l=t.<span class="hljs-property">lastIndex</span>;<span class="hljs-keyword">const</span> a=<span class="hljs-keyword">new</span> <span class="hljs-title class_">RegExp</span>(<span class="hljs-string">&quot;[ \\t]*(.*)&quot;</span>,<span class="hljs-string">&quot;sy&quot;</span>);<span class="hljs-keyword">return</span> a.<span class="hljs-property">lastIndex</span>=l,s=a.<span class="hljs-title function_">exec</span>(n),i+r+((o=s==<span class="hljs-literal">null</span>?<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>:s[<span class="hljs-number">1</span>])!=<span class="hljs-literal">null</span>?<span class="hljs-attr">o</span>:<span class="hljs-string">&quot;&quot;</span>)}<span class="hljs-keyword">function</span> <span class="hljs-title function_">ri</span>(<span class="hljs-params">n,e</span>){<span class="hljs-keyword">let</span> t=<span class="hljs-string">&quot;&quot;</span>;<span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> s=<span class="hljs-number">1</span>;s&lt;n.<span class="hljs-property">length</span>-<span class="hljs-number">1</span>;++s){<span class="hljs-keyword">const</span> i=n[s];<span class="hljs-keyword">if</span>(!(i===<span class="hljs-string">&quot;\r&quot;</span>&amp;&amp;n[s+<span class="hljs-number">1</span>]===<span class="hljs-string">`
`</span>))<span class="hljs-keyword">if</span>(i===<span class="hljs-string">`
`</span>){<span class="hljs-keyword">const</span>{<span class="hljs-attr">fold</span>:r,<span class="hljs-attr">offset</span>:l}=<span class="hljs-title function_">li</span>(n,s);t+=r,s=l}<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(i===<span class="hljs-string">&quot;\\&quot;</span>){<span class="hljs-keyword">let</span> r=n[++s];<span class="hljs-keyword">const</span> l=ai[r];<span class="hljs-keyword">if</span>(l)t+=l;<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(r===<span class="hljs-string">`
...
`</span>)<span class="hljs-keyword">for</span>(r=n[++s+<span class="hljs-number">1</span>];r===<span class="hljs-string">&quot; &quot;</span>||r===<span class="hljs-string">&quot;	&quot;</span>;)r=n[++s+<span class="hljs-number">1</span>];<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(r===<span class="hljs-string">&quot;x&quot;</span>||r===<span class="hljs-string">&quot;u&quot;</span>||r===<span class="hljs-string">&quot;U&quot;</span>){<span class="hljs-keyword">const</span> a={<span class="hljs-attr">x</span>:<span class="hljs-number">2</span>,<span class="hljs-attr">u</span>:<span class="hljs-number">4</span>,<span class="hljs-attr">U</span>:<span class="hljs-number">8</span>}[r];t+=<span class="hljs-title function_">oi</span>(n,s+<span class="hljs-number">1</span>,a,e),s+=a}<span class="hljs-keyword">else</span>{<span class="hljs-keyword">const</span> a=n.<span class="hljs-title function_">substr</span>(s-<span class="hljs-number">1</span>,<span class="hljs-number">2</span>);<span class="hljs-title function_">e</span>(s-<span class="hljs-number">1</span>,<span class="hljs-string">&quot;BAD_DQ_ESCAPE&quot;</span>,<span class="hljs-string">`Invalid escape sequence <span class="hljs-subst">${a}</span>`</span>),t+=a}}<span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(i===<span class="hljs-string">&quot; &quot;</span>||i===<span class="hljs-string">&quot;	&quot;</span>){<span class="hljs-keyword">const</span> r=s;<span class="hljs-keyword">let</span> l=n[s+<span class="hljs-number">1</span>];<span class="hljs-keyword">for</span>(;l===<span class="hljs-string">&quot; &quot;</span>||l===<span class="hljs-string">&quot;	&quot;</span>;)l=n[++s+<span class="hljs-number">1</span>];l!==<span class="hljs-string">`
`</span>&amp;&amp;!(l===<span class="hljs-string">&quot;\r&quot;</span>&amp;&amp;n[s+<span class="hljs-number">2</span>]===<span class="hljs-string">`
`</span>)&amp;&amp;(t+=s&gt;r?n.<span class="hljs-title function_">slice</span>(r,s+<span class="hljs-number">1</span>):i)}<span class="hljs-keyword">else</span> t+=i}<span class="hljs-keyword">return</span>(n[n.<span class="hljs-property">length</span>-<span class="hljs-number">1</span>]!==<span class="hljs-string">&#x27;&quot;&#x27;</span>||n.<span class="hljs-property">length</span>===<span class="hljs-number">1</span>)&amp;&amp;<span class="hljs-title function_">e</span>(n.<span class="hljs-property">length</span>,<span class="hljs-string">&quot;MISSING_CHAR&quot;</span>,<span class="hljs-string">&#x27;Missing closing &quot;quote&#x27;</span>),t}<span class="hljs-keyword">function</span> <span class="hljs-title function_">li</span>(<span class="hljs-params">n,e</span>){<span class="hljs-keyword">let</span> t=<span class="hljs-string">&quot;&quot;</span>,s=n[e+<span class="hljs-number">1</span>];<span class="hljs-keyword">for</span>(;(s===<span class="hljs-string">&quot; &quot;</span>||s===<span class="hljs-string">&quot;	&quot;</span>||s===<span class="hljs-string">`
