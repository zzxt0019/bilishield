...
<span class="hljs-comment">// @version         1.1.1675422343304</span>
...
<span class="hljs-comment">// @description     bilibili屏蔽 更新时间: 2023-02-03 19:05:43.304</span>
...
`</span>&amp;&amp;k!==<span class="hljs-string">&quot;	&quot;</span>&amp;&amp;k!==<span class="hljs-string">&quot; &quot;</span>)<span class="hljs-keyword">break</span>}<span class="hljs-keyword">let</span> p=t.<span class="hljs-title function_">substring</span>(h);<span class="hljs-keyword">const</span> y=p.<span class="hljs-title function_">indexOf</span>(<span class="hljs-string">`
...
$&amp;`</span>).<span class="hljs-title function_">replace</span>(<span class="hljs-regexp">/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g</span>,<span class="hljs-string">&quot;$1$2&quot;</span>).<span class="hljs-title function_">replace</span>(<span class="hljs-regexp">/\n+/g</span>,<span class="hljs-string">`$&amp;<span class="hljs-subst">${c}</span>`</span>);<span class="hljs-keyword">const</span> _=<span class="hljs-title class_">Ze</span>(<span class="hljs-string">`<span class="hljs-subst">${b}</span><span class="hljs-subst">${t}</span><span class="hljs-subst">${p}</span>`</span>,c,<span class="hljs-title class_">St</span>,<span class="hljs-title function_">et</span>(s));<span class="hljs-keyword">return</span><span class="hljs-string">`<span class="hljs-subst">${O}</span>
...
`</span>),J=we!==-<span class="hljs-number">1</span>,<span class="hljs-title class_">Ri</span>=(K=(C=t.<span class="hljs-property">inFlow</span>)!=<span class="hljs-literal">null</span>?<span class="hljs-attr">C</span>:e.<span class="hljs-property">flow</span>)!=<span class="hljs-literal">null</span>?<span class="hljs-attr">K</span>:e.<span class="hljs-property">items</span>.<span class="hljs-property">length</span>===<span class="hljs-number">0</span>;<span class="hljs-keyword">if</span>(J||!<span class="hljs-title class_">Ri</span>){<span class="hljs-keyword">let</span> tn=!<span class="hljs-number">1</span>;<span class="hljs-keyword">if</span>(J&amp;&amp;(G===<span class="hljs-string">&quot;&amp;&quot;</span>||G===<span class="hljs-string">&quot;!&quot;</span>)){<span class="hljs-keyword">let</span> ke=_.<span class="hljs-title function_">indexOf</span>(<span class="hljs-string">&quot; &quot;</span>);G===<span class="hljs-string">&quot;&amp;&quot;</span>&amp;&amp;ke!==-<span class="hljs-number">1</span>&amp;&amp;ke&lt;we&amp;&amp;_[ke+<span class="hljs-number">1</span>]===<span class="hljs-string">&quot;!&quot;</span>&amp;&amp;(ke=_.<span class="hljs-title function_">indexOf</span>(<span class="hljs-string">&quot; &quot;</span>,ke+<span class="hljs-number">1</span>)),(ke===-<span class="hljs-number">1</span>||we&lt;ke)&amp;&amp;(tn=!<span class="hljs-number">0</span>)}tn||(k=<span class="hljs-string">`
