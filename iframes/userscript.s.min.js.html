...
<span class="hljs-comment">// @version         1.1.1675411564966</span>
...
<span class="hljs-comment">// @updateURL       https://zzxt0019.github.io/bilishield/userscript.min.js</span>
<span class="hljs-comment">// @downloadURL     https://zzxt0019.github.io/bilishield/userscript.min.js</span>
...
<span class="hljs-comment">// @description     bilibili屏蔽 更新时间: 2023-02-03 16:06:04.966</span>
...
`</span>),J=we!==-<span class="hljs-number">1</span>,<span class="hljs-title class_">Ri</span>=(K=(C=t.<span class="hljs-property">inFlow</span>)!=<span class="hljs-literal">null</span>?<span class="hljs-attr">C</span>:e.<span class="hljs-property">flow</span>)!=<span class="hljs-literal">null</span>?<span class="hljs-attr">K</span>:e.<span class="hljs-property">items</span>.<span class="hljs-property">length</span>===<span class="hljs-number">0</span>;<span class="hljs-keyword">if</span>(J||!<span class="hljs-title class_">Ri</span>){<span class="hljs-keyword">let</span> tn=!<span class="hljs-number">1</span>;<span class="hljs-keyword">if</span>(J&amp;&amp;(G===<span class="hljs-string">&quot;&amp;&quot;</span>||G===<span class="hljs-string">&quot;!&quot;</span>)){<span class="hljs-keyword">let</span> <span class="hljs-title class_">Se</span>=_.<span class="hljs-title function_">indexOf</span>(<span class="hljs-string">&quot; &quot;</span>);G===<span class="hljs-string">&quot;&amp;&quot;</span>&amp;&amp;<span class="hljs-title class_">Se</span>!==-<span class="hljs-number">1</span>&amp;&amp;<span class="hljs-title class_">Se</span>&lt;we&amp;&amp;_[<span class="hljs-title class_">Se</span>+<span class="hljs-number">1</span>]===<span class="hljs-string">&quot;!&quot;</span>&amp;&amp;(<span class="hljs-title class_">Se</span>=_.<span class="hljs-title function_">indexOf</span>(<span class="hljs-string">&quot; &quot;</span>,<span class="hljs-title class_">Se</span>+<span class="hljs-number">1</span>)),(<span class="hljs-title class_">Se</span>===-<span class="hljs-number">1</span>||we&lt;<span class="hljs-title class_">Se</span>)&amp;&amp;(tn=!<span class="hljs-number">0</span>)}tn||(S=<span class="hljs-string">`
